...
def app():
    ...
    latitude = st.number_input("Latitude of the place you're launching",
                               ...
                               step=1e-12,
                               format="%.5f")
    longitude = st.number_input("Longitude of the place you're launching",
                                min_value=-180.0,
                                max_value=180.0,
                                step=1e-12,
                                format="%.5f")
    ...
    elevation = st.number_input(
        "What's the mean sea level elevation in meters?")
    ...
    Env = Environment(railLength=railLength, latitude=latitude,
