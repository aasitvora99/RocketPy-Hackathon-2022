    ...
    with st.container():
        ...
        with col1:
            with st.container():
                ...
                st.session_state.rocketInfo["powerOffDrag"] = st.file_uploader(
                ...
                if st.session_state.rocketInfo["powerOffDrag"] is not None:
                    with open(
                        os.path.join(
                            "streamlitFiles\__pycache__",
                            st.session_state.rocketInfo["powerOffDrag"].name,
                        ),
                        "wb",
                    ) as f:
                        f.write(st.session_state.rocketInfo["powerOffDrag"].getbuffer())
        ...
        with col2:
            with st.container():
                st.session_state.rocketInfo["powerOnDrag"] = st.file_uploader(
                    label="Power off Drag Curve Data",
                ...
                if st.session_state.rocketInfo["powerOnDrag"] is not None:
                    with open(
                        os.path.join(
                            "streamlitFiles\__pycache__",
                            st.session_state.rocketInfo["powerOnDrag"].name,
                        ),
                        "wb",
                    ) as f:
                        f.write(st.session_state.rocketInfo["powerOnDrag"].getbuffer())
            ...
            with aeroTab:
                ...
                with col2:
                    ...
                    rokit.addFins(
                        ...
                        st.session_state.rocketInfo["finSpan"],
                        st.session_state.rocketInfo["finRC"],
                        st.session_state.rocketInfo["finTC"],
                        st.session_state.rocketInfo["finDistanceToCM"],
                        radius=0,
                        cantAngle=0,
                    )
                    ...
                    if addTailCheck:
                        ...
                        if tailSubmit:
                            rokit.addTail(
                                ...
                                distanceToCM=st.session_state.rocketInfo[
                                    "tailDistanceToCM"
                                ],
                            )
            with parachuteTab:
